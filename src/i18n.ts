...
const STR = {
  tr: {
    ...
    fiveHourShort: "5 saat",
    hRange24: "24 saat",
    hRange7: "7 gün",
    hRange30: "30 gün",
    hEmpty: "Henüz kayıt yok. Uygulama açık kaldıkça her yenilemede bir nokta eklenir.",
    hPeakFive: "En yüksek 5 saat",
    hPeakWeek: "En yüksek haftalık",
    hSince: "{date} tarihinden beri kaydediliyor",
    hLocal: "Geçmiş sadece bu bilgisayarda tutulur",
    hExport: "CSV dışa aktar",
    hExported: "İndirilenler'e kaydedildi",
    hExportEmpty: "Dışa aktarılacak kayıt yok",
    hAria: "Kullanım geçmişi grafiği. En yüksek 5 saat {five}, en yüksek haftalık {week}.",
    sMini: "Mini pencere",
  ...
  en: {
    ...
    hRange7: "7 days",
    hRange30: "30 days",
    hEmpty: "No records yet. A point is added on every refresh while the app runs.",
    hPeakFive: "5-hour peak",
    hPeakWeek: "Weekly peak",
    hSince: "Recording since {date}",
    hLocal: "History stays on this computer",
    hExport: "Export CSV",
    hExported: "Saved to Downloads",
    hExportEmpty: "Nothing to export yet",
    hAria: "Usage history chart. 5-hour peak {five}, weekly peak {week}.",
    sMini: "Mini window",
